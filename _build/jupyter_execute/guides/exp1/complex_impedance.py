...
Para visulizar a relação entre as impedância complexas acima e o que se observa em um osciloscópio, basta tomarmos a parte real do sinal complexo. Suponha que tenhamos uma corrente $I(t)=i_0 \cos(\omega t+\phi)$ no nosso circuito. A corrente complexa associada será 
$$
\tilde{I}(t)=i_0 \exp(j\omega t+\phi)=\tilde{i}_0\exp(j\omega t),
$$ (eq:complex_current)
sendo que $\tilde{i}_0=i_0\exp(j\phi)$
...
```{image} figs/circuito_rc_fases.jpeg
:alt: circuit picture
:width: 400px
:align: center
```
